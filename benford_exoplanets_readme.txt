	BENFORD EXOPLANETS PROJECT

	This R project in Data Analysis was meant to test the Benford's Law on an astronomic dataset
	...
	For the sake of the Search for New Earths, the data describe the change in flux (light intensity)
of several thousand stars.
